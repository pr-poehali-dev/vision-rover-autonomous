...
const HeroSection = () => {
  return (
    ...
    >
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-end lg:mx-8 px-0 mx-[42px]">
        <div className="text-left px-0 my-0 py-0 lg:pr-4 flex flex-col justify-between min-h-full">
          <div>
            <h1
