...
const FinalCTA = () => {
  return (
    <section className="py-[34px] sm:py-16 lg:py-20 px-4 sm:px-6 bg-[#EE686A]">
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-md mx-auto sm:mx-0">
          <Input
            ...
            className="flex-1 text-base sm:text-lg px-4 py-4 sm:py-6 rounded-xl border-white/30 bg-white/90 text-black placeholder:text-black/60 focus:border-white focus:ring-white/20 focus:bg-white"
          />
          <Button
